...
-- 3) Write SQL statements to insert the following new books into the database. 
...
-- 4) Write a SQL statement to add a uniqueness constraint on the combination of columns book_id and category_id of the books_categories table. 
