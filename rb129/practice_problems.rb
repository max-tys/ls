...
# class Person
#   def to_s; @self_introduction end

#   def initialize(name, job)
#     @name = name
#     @self_introduction = "My name is #{name} and I am a #{job}."
#   end
# end
...
#   def self.hair_colour(_) # what's the purpose of the empty string argument?
#     dylan = Human.new
#     dylan.hair_colour
#   end
# end
...
#   def +(other)
#     "annagilles" # Is there even a way to refer to a local variable name?
#   end
# end
